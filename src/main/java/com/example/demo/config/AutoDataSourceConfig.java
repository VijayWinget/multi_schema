...
@EnableJpaRepositories(
    basePackages = "com.example.demo.auto.repository",
...
public class AutoDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean autoEntityManagerFactory(
            EntityManagerFactoryBuilder builder) {
        return builder
                .dataSource(autoDataSource())
                .packages("com.example.demo.auto.entity")
                .persistenceUnit("auto")
                .build();
    }
	@Primary
